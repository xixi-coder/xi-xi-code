...
//            testNewOldDateConversion();
        ...
        public static void test1(){
            ...
            DateTimeFormatter dateTimeFormatter3 = DateTimeFormatter.ofPattern(dateFormatter3);
            LocalDateTime stLocalDateTime = LocalDateTime.parse("2022-02-25 12:23:03", dateTimeFormatter1);
            System.out.println(stLocalDateTime.getMonth().getValue());
            System.out.println(stLocalDateTime.getYear());
            System.out.println(dateTimeFormatter3.format(stLocalDateTime));
        }

    private static final String dateFormatter1 = "yyyy-MM-dd HH:mm:ss";
    private static final String dateFormatter3 = "yyyyMM";
